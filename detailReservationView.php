...
reservation, customer, car_type
 ...
 reservation.customer_id=customer.customer_id and reservation_id='$reservation_id' order by reservation_id ";
// echo"$sql";
...
<table border="1">
  ...
  echo "<tr><td>Image</td><td><img src=car_image/$row[images] width=200 height=200 class=img-rounded></td></tr> ";
    echo "<tr><td>Rent</td><td>" . $row["rent"]. " </td></tr> ";
      echo "<tr><td>Return Time</td><td>" . $row["return_time"]. " </td></tr> ";
